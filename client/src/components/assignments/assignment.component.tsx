...
const Assignment = () => {
  ...
  return (
    <div className="assignments-section">
      ...
      {
        user.role == "student" ? currentActiveComponent == "submissions" ? <Submissions /> : currentActiveComponent == "old" ? <AssignmentsList user={user} fetchBootcampAssignments={fetchBootcampAssignments} setCurrentActiveComponent={setCurrentActiveComponent} assignments={oldAssignments} />
          : <AssignmentsList user={user} fetchBootcampAssignments={fetchBootcampAssignments} setCurrentActiveComponent={setCurrentActiveComponent} assignments={upcomingAssignments} /> :
          currentActiveComponent == "create" ? <CreateAssignment fetchBootcampAssignments={fetchBootcampAssignments} /> :
            <AssignmentsList setCurrentActiveComponent={setCurrentActiveComponent} user={user} fetchBootcampAssignments={fetchBootcampAssignments} assignments={currentActiveComponent == 'old' ? oldAssignments : upcomingAssignments} />
      }
    </div>
  )
}
